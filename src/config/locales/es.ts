export const es: Record<string, string> = {
  ...
  "home.contact.sent": "¡Enviado!",
  "home.contact.error":
    "Error al enviar el mensaje. Por favor, inténtalo de nuevo.",
  "home.contact.errorNameTooShort": "El nombre debe tener al menos 2 caracteres.",
  "home.contact.errorNameTooLong": "El nombre debe tener como máximo 100 caracteres.",
  "home.contact.errorEmailInvalid": "Por favor, introduce una dirección de correo electrónico válida.",
  ...
  "works.subtitle": "Una colección de mis proyectos y cosas que he construido.",
  ...
  "credits.subtitle":
    "Reconocimiento a las herramientas de código abierto, tipografía y recursos que impulsan este sitio.",
  "credits.sourceCode": "Código fuente",
  ...
  "credits.tech.forms": "Formularios",
  ...
  "credits.media.introTitle": "VIDEO DE INTRODUCCIÓN",
  ...
  "social.redirect.title": "Redirección externa",
  "social.redirect.message": "Serás redirigido a {platform}. ¿Aceptas?",
  "social.redirect.accept": "Aceptar",
  "social.redirect.cancel": "Cancelar",

  // Certification details modal
  "cert.details": "Detalles del Certificado",
  ...
  "blog.entityType.skill": "Habilidad",
  "blog.entityType.language": "Idioma",
  "blog.entityType.activity": "Actividad",
  "blog.entityType.certification": "Certificación",
